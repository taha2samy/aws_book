...
resource "aws_spot_instance_request" "just_example" {

  spot_price = "0.009"
  instance_type = aws_launch_template.ec2_launch_template.instance_type
  ami = aws_launch_template.ec2_launch_template.image_id
  subnet_id = aws_launch_template.ec2_launch_template.network_interfaces[0].subnet_id
  key_name = aws_launch_template.ec2_launch_template.key_name
  user_data = aws_launch_template.ec2_launch_template.user_data
  tags = {
    Name = "Just Example  spot Instance"
  }
}
